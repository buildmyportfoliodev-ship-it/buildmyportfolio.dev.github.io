/* ============================================================
   SHERLOCK HOLMES PORTFOLIO – script.js
   ============================================================ */
...
(function () {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function (e) {
      // Only intercept if using the demo (no real FormSubmit setup)
      // Comment out the next 3 lines when deploying with a real form backend
      e.preventDefault();
      showFormMessage('success', "Your message has been sent! I'll be in touch within 24 hours.");
      contactForm.reset();
    });
  }
